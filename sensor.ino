...
// Declaração das variáveis com os valores de leitura dos sensores
bool Sensor1 = 0;
bool Sensor2 = 0;

//variável responsável por controlar a velocidade dos motores
// se quiser ir mais rápido aumente esse valor
int velocidade = 150;
void setup() {
  //Setamos os pinos de controle dos motores como saída (A informação sai do arduíno e vai para o motor)
  pinMode(M1, OUTPUT);
  pinMode(M2, OUTPUT);
  pinMode(dir1, OUTPUT);
  pinMode(dir2, OUTPUT);
  ...
  //Setamos os pinos dos sensores como entrada (A informação vem do sensor para o arduino)
  pinMode(pin_S1, INPUT);
  pinMode(pin_S2, INPUT);
}

// o loop significa que isso vai ficar sendo executado sem parar
void loop() {
